...
```{r, fig.width=8, fig.height=6, fig.cap="Figure. Total prescribing of asthma biologics for 20 Trusts with the largest volume across all selected medications."}
temp_ggplot <- df_scmd_asthma_ddd_map %>% 
  ...
  geom_bar(aes(y = volume_ddd,
               fill = vtmnm,
               text = paste0("<b>Trust:</b> ", stp_name, "<br>",
                             "<b>Volume:</b> ", round(total, 0), "<br>",
                             "<b>Proportion:</b> ", scales::percent(prop_use, accuracy = 0.1), "<br>",
                             "<b>Medication:</b> ", vtmnm)), 
           stat='identity',
