...
The file `data/meds_rheumatology_meds.csv` contains the SNOMED codes for the medicines we are investigating.
...
codelist <- read_csv(here("data/meds_rheumatology_meds.csv"),
