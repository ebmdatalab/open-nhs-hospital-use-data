...
In September 2020 NHS BSA published hospital medicines data for the first time. We have prepared the following notebook for investigating the use of bilogic medicines in English hospitals.

## Contents
[Data preparation](#prep)

## Data preparation <a name="section"></a>
