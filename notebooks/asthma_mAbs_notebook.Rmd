...
hospital_to_stp_map <- read.csv(file = "C:/Users/HP/Documents/GitHub/open-nhs-hospital-use-data/data/etr.csv", header = FALSE) %>%
  select(1:4) 
...
stp_to_region_map <- read.csv("C:/Users/HP/Documents/GitHub/open-nhs-hospital-use-data/data/gp-reg-pat-prac-map.csv") %>%
