...
# Create variable ranging from 0 to 1 to use consistent conditional formatting across tables/notebooks
data_tab <- df_scmd_ddd_map_temp_temp %>% 
  mutate(prop_scale = seq(from = 0, 
                          to = 1, 
                          length = nrow(df_scmd_ddd_map_temp_temp)))
...
col_def_list_all_vars <- c(col_def_list_stp, col_def_list_prop_all, col_def_list_total_ddd, col_def_list_prop_scale)
